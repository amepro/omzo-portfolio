...
à me poser ?</h4>
              <p>
Toujours disponible en freelance si le bon projet se présente
n'hésitez pas à me contacter.
              ...
              <ul>
                <li className="media">
                  ...
                  <span className="media-body">
                    Derklé - Cité Marine, Dakar Sénégal.
                  </span>
                </li>
                <li className="media">
                  <i className="ti-email" />
                  <span className="media-body">oumarsamb023@gmail.com</span>
                </li>
                <li className="media">
                  <i className="ti-mobile" />
                  <span className="media-body">+221 77 621 45 71</span>
                </li>
              </ul>
            </div>
          </div>
          <div className="col-lg-7 col-xl-8 m-15px-tb">
            <div className="contact-form">
              <h4>Contactez-moi à partir du formulaire ci-après</h4>
